...
const awards = [
  { title: "SK쉴더스 클라우드/보안 전문가 양성 캠프 3기 최종 프로젝트", award: "장려상", year: "2026" },
  { title: "2023 벤처 스타트업 아카데미 (SW/컨텐츠 분야)", award: "우수상", year: "2024" },
  { title: "2023 중소벤처기업부 벤처스타트업 아카데미 소감문 경진대회", award: "우수상", year: "2024" },
];
